...
Vue.component("column", {
  props: ["width"],
  template:
    '<div class="column" :style=\'{ flexBasis: width + "%" }\'><slot></slot></div>',
});
  ...
  template: `
	<div class='section'>
		...
		<div v-for='job in data' class='sub-section'>
			...
			<ul class="sub-section sub-section-list" v-if="expand" :style='{ height: 2.3 + "rem" }'><li v-for="r in job.results">{{r}}</li></ul>
